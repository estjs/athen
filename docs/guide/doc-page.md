...
The left sidebar is configured per-page (frontmatter), per-folder (`_meta.json`), and via `themeConfig.sidebar`. See the dedicated [Sidebar](./sidebar) guide for all options.
