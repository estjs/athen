...
Athen 支持 [Mdx](https://mdxjs.com/)，这是一种功能强大的内容开发方式，你可以在 Markdown 文件中导入和使用 Essor 组件。
...
> 注意：Athen 使用页面的 `# 一级标题` 作为 HTML 文档标题；不再提供 `title` Front Matter 字段。

你还可以在正文中访问 Front Matter 中定义的任意属性，例如：
